        ...
        ElevatedButton(
            onPressed: () {
              Navigator.pushNamedAndRemoveUntil(
                  context, '/two/three', ((route) => false));
            },
            child: const Center(child: Text("push /two/three"))),
        ElevatedButton(
            onPressed: () {
              Navigator.pushNamed(context, '/two/four');
            },
            child: const Center(child: Text("push /two/four"))),
        Padding(
